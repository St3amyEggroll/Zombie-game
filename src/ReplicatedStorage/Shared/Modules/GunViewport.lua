...
function GunViewport.Create(weaponId: string, spin: boolean?, folderName: string?)
	...
	-- rim looked wrong — UI previews render the plain model. World guns get the REAL outline for free,
	-- since the held model is part of the character its Highlight covers.)
